    ...
    <div style="display: flex;">
      <div style="flex: 1; margin-right: 4px;">
        ...
        <div style="display: flex; align-items: center; margin-bottom: 4px;">
          <span>Uploader:</span>
          <img :src="infoProps.avatarUrl" loading="lazy" alt="user's avatar" class="avatar" @click="onAvatarClick">
        </div>

        <div style="display: flex;">
          <button style="flex: 1;" :disabled="infoProps.trackData == null || infoProps.trackData?.offline" @click="onAddToPlaylist">Add to playlist</button>
      ...
      <img style="flex: 1;" loading="lazy" alt="thumbnail" :src="thumbnail" class="thumbnail">
    </div>
