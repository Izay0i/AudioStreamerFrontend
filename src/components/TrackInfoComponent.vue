<template>
  <div style="flex: 1; display: flex; flex-direction: column; overflow: auto;">
    ...
    <div style="display: flex; align-items: center; margin-bottom: 4px;">
      <span>By:</span>
      <img :src="infoProps.avatarUrl" class="avatar" @click="onAvatarClick">
    </div>
...
onUpdated(async () => {
  ...
  trackId.value = infoProps.trackData.trackId;
...
const onRate = async () => {
  if (infoProps.trackData == null || userId.value == null) {
    return;
  }
  ...
  //else update rate
  await _handleStats();
  if (rating.value === defaultRatingValue) {
